...
**M11** is next — first substantive **Phase C** milestone (workspace `docs/milestones/M11/`; scope locked at kickoff per *Execution Phase Boundaries*).
